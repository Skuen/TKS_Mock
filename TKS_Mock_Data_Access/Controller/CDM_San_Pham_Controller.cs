...
namespace TKS_Mock_Data_Access.Controller
{
    public class CDM_San_Pham_Controller
    {
        ...
        public int FQ_165_SP_sp_del_Delete_By_ID(string p_iAuto_ID)
        {
            int v_iRes = CConst.INT_VALUE_NULL;
            try
            {
                v_iRes = CSqlHelper.ExecuteNonquery(CConfig.TKS_Mock_Conn_String, "FQ_165_SP_sp_del_Delete_By_ID", p_iAuto_ID);
            }
